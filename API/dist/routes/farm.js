...
router.post('/plant-seed', (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
      ...
      if (!slot || !seed) {
        return res
          .status(404)
          .json({ message: 'Slot o semilla no encontrada' });
      }
...
router.put('/water-plant', (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
      ...
      if (slot.growthStatus !== 'WATER_NEEDED') {
        return res
          .status(400)
          .json({
            message: 'La planta no necesita ser regada en este momento',
          });
      }
      ...
      if (
        !userInventory ||
        !userInventory.waters.some((w) => w.id === waterId)
      ) {
        return res
          .status(403)
...
router.delete('/delete-plant', (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
      ...
      if (!(slot === null || slot === void 0 ? void 0 : slot.seedName)) {
      ...
      if (slot.farmId !== farmId) {
        return res
          .status(403)
          .json({
            message: 'You do not have permission to delete this plant.',
          });
      }
      const user = yield prisma.user.findUnique({
        where: { sub },
...
router.put('/harvest-plant', (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
      ...
      if (slot.growthStatus !== 'READY_TO_HARVEST') {
        return res
          .status(400)
          .json({
            message: 'La planta no puede ser cosechada en este momento',
          });
      }
