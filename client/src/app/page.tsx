  ...
  return (
    <div className="w-full bg-[#FFF5D1] min-h-screen flex flex-col items-center justify-center">
      <div className="text-center">
        <h1 className="text-6xl font-bold text-[#A8D5BA] mb-8">
          Welcome to FarmSim
        </h1>
        <p className="text-xl text-[#333] mb-8 max-w-xl">
          Immerse yourself in the world of farming simulations. Enjoy the
          experience of managing your own farm, cultivating crops, raising
          animals, and trading goods!
        </p>
        <Link href="/Home">
